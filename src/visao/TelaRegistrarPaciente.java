...
public class TelaRegistrarPaciente extends JFrame {
	...
	public TelaRegistrarPaciente() {
		...
		panel.setLayout(new MigLayout("", "[72.00][321.00,grow]", "[grow][56.00,grow][68.00,grow][66.00,grow][68.00,grow][80.00,grow]"));
		...
		gl_panel_2.setHorizontalGroup(
			gl_panel_2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_2.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtcpfP, GroupLayout.DEFAULT_SIZE, 524, Short.MAX_VALUE)
					.addContainerGap())
		);
		...
		gl_panel_3.setVerticalGroup(
			gl_panel_3.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panel_3.createSequentialGroup()
					.addGap(39)
					.addComponent(txtTelefoneP, GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)
					.addGap(20))
		);
		...
		gl_panel_4.setHorizontalGroup(
			gl_panel_4.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_panel_4.createSequentialGroup()
					.addContainerGap()
					.addComponent(cbSexo, 0, 518, Short.MAX_VALUE)
					.addGap(10))
		);
		gl_panel_4.setVerticalGroup(
			gl_panel_4.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_4.createSequentialGroup()
					.addGap(27)
					.addComponent(cbSexo, GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)
					.addGap(24))
		);
		...
		gl_panel_5.setHorizontalGroup(
			gl_panel_5.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_5.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtEmailP, GroupLayout.DEFAULT_SIZE, 524, Short.MAX_VALUE)
					.addContainerGap())
		);
