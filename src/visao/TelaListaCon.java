...
public class TelaListaCon extends JFrame {
	...
	public TelaListaCon(Usuario usuarioLogado) {
		...
		contentPane.add(btnNewButton, "cell 0 4,alignx center");
		
		JButton btnNewButton_1 = new JButton("Deletar Consulta");
		btnNewButton_1.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		contentPane.add(btnNewButton_1, "cell 1 4,alignx center");
		...
		contentPane.add(btnNewButton_2, "cell 2 4,alignx center");
	}
